...
public class MyF_DianzanFragment extends Fragment {
...
//        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //使用recyclerView
        RecyclerView recyclerView =  rootView.findViewById(R.id.dianzan);
...
//        LinearLayoutManager layoutManager = new LinearLayoutManager(getActivity());
        ...
        newsAdapterUser = new NewsAdapter_user(rootView.getContext(),R.layout.list_item_1, newsUserpaperList,mParam1,flag);//getContext()?
...
//    }
    ...
    private void get(){
        new Thread(() -> {
            ...
            // url路径
            String url = "http://47.107.52.7:88/member/photo/like?userId="+mParam1;
    ...
    private void innit(String body) throws JSONException {
        ...
        JSONObject jsonObject = new JSONObject(body)
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                System.out.println("点赞里的likeId:" + newsUserpaper.getLikeId());
