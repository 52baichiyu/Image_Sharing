...
//            e.printStackTrace();
//        }
//        RecyclerView recyclerView = findViewById(R.id.lv_news_list);
//        System.out.println("newsList的值为："+newsList);
//        newsAdapter = new NewsAdapter(Find.this,
//                R.layout.list_item,
//                newsList
//        );
...
//                        Intent intent=new Intent(Find.this,
//                                itemDetails.class);
...
//                            .add("appId", "b59354bb9429401e857ebeefeff16dbe")
//                            .add("appSecret", "600472154a10944574feb9ba3347f018c019a")
